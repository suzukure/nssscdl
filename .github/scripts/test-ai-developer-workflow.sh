...
grep -Fq '/usr/bin/stat -Lc "%u" "$path"' "$developer_step"
grep -Fq '/usr/bin/stat -Lc "%F" "$path"' "$developer_step"
grep -Fq '/usr/bin/stat -Lc "%d:%i" "$path"' "$developer_step"
grep -Fq 'Protected UNIX socket baseline is unexpected:' "$developer_step"
