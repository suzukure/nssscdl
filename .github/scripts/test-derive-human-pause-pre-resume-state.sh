...
assert_rejected non-object-record '{"target":"issue:277","chains":[{"records":[null]}]}'
...
assert_rejected acceptance-first "$(envelope "$(chain "$(entry 301 ai-resume-accepted requirements_change 300)")")"
